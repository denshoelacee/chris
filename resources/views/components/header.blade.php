...
<header>
    ...
    <nav class="flex items-center justify-between p-8 ">
        ...
        <ul class="hidden md:flex md:ml-auto flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-8 mr-10 gap-7">
            ...
            <li>
                <a href="{{ request()->is('about') ? '#about' : route('about') }}" class="text-black hover:text-blue-800 font-black">About Us</a>
            </li>
            <li>
                <a href="{{ request()->is('home') ? '#services' : route('home') . '#services' }}" class="text-black hover:text-blue-800 font-black">Services</a>
            </li>
            <li>
                <a href="{{ request()->is('home') ? '#contact' : route('home') . '#contact' }}" class="pr-10 text-black hover:text-blue-800 font-black">Contact Us</a>
            </li>
            <x-log-in-buttons>
